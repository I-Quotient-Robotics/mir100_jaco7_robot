...
#include <mir100_jaco7_app/PickGift.h>
...
bool PickGiftCB(mir100_jaco7_app::PickGift::Request &req, mir100_jaco7_app::PickGift::Response &res) {
  if(get_new_target < 0) {
...
int main(int argc, char** argv) {
  ros::init(argc, argv, "mir100_jaco7_app_node");
